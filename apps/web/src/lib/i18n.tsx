...
const translations = {
  ...
  myLibrary: {
    ...
    uploadDescription: { es: "Descripción (opcional)", en: "Description (optional)" },
  ...
  artifactDetail: {
    ...
    descriptionPlaceholder: { es: "Descripción breve…", en: "Brief description…" },
  ...
  customFields: {
    ...
    publicShowcase: { es: "Vitrina pública", en: "Public showcase" },
  },
  showcase: {
    title: { es: "Vitrina", en: "Showcase" },
    loading: { es: "Cargando…", en: "Loading…" },
    empty: { es: "Aún no hay artefactos públicos para mostrar.", en: "No public artifacts to show yet." },
    loadingPreview: { es: "Cargando vista previa…", en: "Loading preview…" },
